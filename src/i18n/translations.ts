...
export const TRANSLATIONS: Record<Language, Translations> = {
  fr: {
    ...
    eligibilityLevelHigh: 'Adéquation forte selon les critères officiels',
    eligibilityLevelModerate: 'Correspondance modérée avec conditions à clarifier',
    eligibilityLevelBlocker: 'Éligibilité restreinte / Critères à adapter',
  ...
  ar: {
    ...
    eligibilityLevelHigh: 'تطابق فني قوي مع الشروط الرسمية',
    eligibilityLevelModerate: 'تطابق متوسط مع ضرورة توضيح بعض الشروط',
    eligibilityLevelBlocker: 'أهلية محدودة / معايير تستوجب التعديل',
